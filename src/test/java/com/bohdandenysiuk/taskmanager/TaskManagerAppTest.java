...
public class TaskManagerAppTest {
	...
	void removeTaskRemovesMiddleTask() {
		...
		int actualCount = TaskManagerApp.removeTask(values, 3, 1);
	...
	void removeTaskRemovesFirstTask() {
		...
		int actualCount = TaskManagerApp.removeTask(values, 3, 0);
	...
	void removeTaskRemovesLastTask() {
		...
		int actualCount = TaskManagerApp.removeTask(values, 3, 2);
	...
	void removeTaskDoesNothingForInvalidIndex() {
		...
		int actualCount = TaskManagerApp.removeTask(values, 3, 3);
	...
	void findTaskIndexFindsExistingTask() {
		String[] values = { "A", "B", "C", null };
		int actualIndex = TaskManagerApp.findTaskIndex(values, 3, "B");
	...
	void findTaskIndexReturnsMinusOneForMissingTask() {
		String[] values = { "A", "B", "C", null };
		int actualIndex = TaskManagerApp.findTaskIndex(values, 3, "D");
	...
	void findTaskIndexReturnsMinusOneForNullArray() {
		String[] values = null;
		int actualIndex = TaskManagerApp.findTaskIndex(values, 0, "A");
	...
	void findTaskIndexReturnsMinusOneForNullTitle() {
		String[] values = { "A", "B" };
		int actualIndex = TaskManagerApp.findTaskIndex(values, 2, null);
	...
	void findTaskIndexIgnoresElementsOutsideLogicalSize() {
		...
		int actualIndex = TaskManagerApp.findTaskIndex(values, 2, "hidden");
